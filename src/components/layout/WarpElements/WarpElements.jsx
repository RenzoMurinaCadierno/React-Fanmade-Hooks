...
import { defaultProps, propTypes } from "./WarpElements.utils"
 ...
 */
export default function WarpElements({ children, portalNode }) {
  ...
  // render children where '*WarpElements*' was called from if no `portalNode`
...
WarpElements.propTypes = propTypes
WarpElements.defaultProps = defaultProps
